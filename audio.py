...
for i, chunk in enumerate(chunks):
    ...
    audio_parts.append(silence(0.35, sample_rate))  # pacing pause
...
sf.write("experience.wav", final_audio, sample_rate)

logger.info("Saved experience.wav successfully")
